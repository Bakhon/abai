...
class PaegtmCarriedOutGtmsImport implements ToModel, WithStartRow, WithBatchInserts, WithChunkReading, WithMultipleSheets
{
    ...
    const COLUMNS = [
        ...
        'oilfield' => 1,
        'uwi' => 2,
        'date_stop_before_gtm' => 3,
        'date_start_after_gtm' => 4,
        'gtm' => 5,
        'planned_increase' => 6,
    ];
    ...
    public function model(array $row)
    {
        ...
        return new CarriedOutGtm([
            ...
            'uwi' => $row[self::COLUMNS['uwi']],
            'well' => $well,
            'date_stop_before_gtm' => $row[self::COLUMNS['date_stop_before_gtm']] ? Date::excelToDateTimeObject($row[self::COLUMNS['date_stop_before_gtm']]) : null,
            'date_start_after_gtm' => $row[self::COLUMNS['date_start_after_gtm']] ? Date::excelToDateTimeObject($row[self::COLUMNS['date_start_after_gtm']]) : null,
