...
return array (
  ...
  array (
    ...
    'detail-data' => 'Подробная информация',
  ),
  'gu' => 
  array (
    'deleted' => 'ГУ удален',
  ...
  array (
    ...
    array (
      ...
      'daily_oil_production' => 'Суточная добыча нефти, т/сут',
      'gas_factor' => 'Суточная добыча газа м3\\сут',
      'bsw' => 'Обводненность, %',
      'pressure' => 'Давление, бар',
      'temperature' => 'Температура, °C',
      'fact_data' => 'Фактические данные ОМГ НГДУ Скважина',
      'sg_oil' => 'Относительная плотность нефти',
      'sg_gas' => 'Относительная плотность газа',
      'sg_water' => 'Относительная плотность воды',
    ),
  ...
  array (
    ...
    'subject' => 'Объект',
    'title' => 'История изменений',
    'old-value' => 'Предыдущее значение',
    'new-value' => 'Новое значение',
    'menu' => 'История изменений',
    'admin' => 
    array (
      'title' => 'История изменений на карте',
    ),
  ),
  'pipe_passport' => 
  array (
    'field' => 'Месторождение',
    'main_reserved' => 'Основной/Резерв',
    'from' => 'От',
    'to' => 'До',
    'diameter' => 'Диаметр',
    'installation_date' => 'Год прокладки',
    'condition' => 'Состояние',
    'gusts' => 'Порывы',
    'used' => 'Б/У',
    'comment' => 'Комментарий',
    'data_sheet' => 'Наличие паспорта',
    'title' => 'Паспортизация трубопроводов',
    'create_title' => 'Ввод данных по паспортизации трубопроводов',
    'name' => 'Наименование',
    'edit_title' => 'Редактирование данных по паспортизации трубопроводов',
  ),
  'permission' => 
  array (
    'main' => 
  ...
  'manual_hydro_calculation' => 
  array (
    'table_title' => 'Таблица расчета гидравлики Скважина - ГУ для новых объектов',
    'section' => 'Объекты на карте добавленные пользвователем',
    'fields' => 
    array (
      'temperature_well' => 'Температура на Скважине',
      'temperature_zu' => 'Температура на ЗУ',
    ),
    'menu' => 'Расчет гидравлики Скважина - ГУ для новых объектов',
  ),
  'settings' => 
  array (
    ...
    'omgca' => 'ОМГ ДДНГ',
    'omgngdu' => 'ОМГ НГДУ',
    'omgngdu_well' => 'ОМГ НГДУ Скважина',
    'omgngdu_zu' => 'ОМГ НГДУ ЗУ',
    'omguhe' => 'ОМГ УХЭ',
