...
return [
    'validation' => [
        ...
        'depthBt' => 'Значение должно быть меньше или равно значению "Искусственный забой"',
    ...
    'forms' => [
        ...
        'well_perf' => [
            ...
            'intervals' => 'Интервалы перфорации, м',
            ...
            'add_explosive_packer' => 'Добавить взрыв пакера',
        ...
        'well_perf_stab' => [
            'title' => 'Интервалы перфорации (прокалывающая перфорация)',
            'main' => 'Основное',
            'perf_t' => 'Вид работ',
            'podr' => 'Подрядчик',
            'perf_y' => 'Тип перфоратора',
        ...
        'well_perf_lagging' => [
            'title' => 'Интервалы перфорации (изоляция)',
            'main' => 'Основное',
            'perf_t' => 'Вид работ',
            'podr' => 'Подрядчик',
            'iso_mat_type' => 'Изолирующий материал',
        ...
        'gdis' => [
            ...
            'depth' => 'Глубина спуска прибора, м',
            'aim' => 'Цель',
            'conclusion' => 'Заключение/Достоверность качества',
        ...
        'research_lab_research' => [
            ...
            'molar_share' => 'Молекулярная масса. Остаток %',
            'stand_density' => 'Плотность при станд.усл-ях, Всего, г/см3',
            'stand_density_resid' => 'Плотность при станд.усл-ях, Остатка, г/см3',
        ...
        'tech_mode_prod' => [
            ...
            'diameter' => 'Диаметр экс.колонны, мм',
            'sk_type' => 'Тип СК',
            'prm' => 'Диаметр насоса, мм',
            'depth' => 'Глубина спуска насоса, м',
            'diameter_nkt' => 'Диаметр НКТ, мм',
            'd_stg' => 'Диаметр штанги, мм',
            'dlina' => 'Длина хода, м',
            'rpm' => 'Число качаний (об/мин)',
            'QZh' => 'Qж',
            'wcut' => 'Обводненность',
            'Qn' => 'Qн',
            'worktime' => 'Отработанное время в категории нефтяная с начала месяца',
            'avg_liquid_prev_month' => 'Средний дебит жидкости за предыдущий месяц',
            'avg_wcut_prev_month' => 'Средняя обводненность за предыдущий месяц',
            'avg_oil_prev_month' => 'Средний дебит нефти за предыдущий месяц',
            'sum_oil_prev_month' => 'Добыча нефти за предыдущий месяц',
        ...
        'tech_mode_inj' => [
            ...
            'diameter' => 'Диаметр экс.колонны, мм',
            'diameter_nkt' => 'Диаметр НКТ, мм',
            'equip' => 'Оборудование низа труб',
            'worktime' => 'Отработанные дни',
            'avg_liquid_prev_month' => 'Среднесуточная закачка жидкости, м3/сут',
            'avg_pressure_month' => 'Среднесуточное давление, атм',
            'avg_temp_prev_month' => 'Среднесуточная температура агента, С ',
            'water_inj' => 'Объем закачки за период, м3 ',
            'volume' => 'Vаг',
            'agent_type' => 'Агент',
            'agent_temp' => 'Температура, С',
            'pressure' => 'Рзак',
            'dbeg' => 'Дата начала',
            'dend' => 'Дата конца',
            'events' => 'Мероприятия',
        ...
        'meas_current_gdis' => [
            ...
            'hdin' => 'Ндин',
            'pzab' => 'Рзаб',
            'pmax' => 'Р максимальной нагрузки',
            'pri' => 'Приемистость нагнетательных скважин',
            'Qzh_teor' => 'Qж теоретическое',
            'Qzh_din' => 'Qж динамическое',
            'bsw' => 'Обводненность',
            'gas_fact' => 'Газовый фактор по скважинам',
            'k_napol' => 'К наполнения',
            'k_nasos' => 'К подачи насоса',
            'p_priv' => 'Р приведенное',
            'ppl' => 'Рпл',
            'pbuf' => 'Р буф',
            'pstat' => 'Р статическое',
            'pzat' => 'Р затрубное',
            ...
            'hstat' => 'Н стат',
            'tpl' => 'Тпл',
            'glubina' => 'Глубина исследования, м',
            'kp' => 'Кп (коэффициент продуктивности)',
            'Hzab' => 'Н заб доход прибора',
            'dlina_gdm' => 'Длина хода при проведении ГДМ',
            'count_gdm' => 'Число качаний при проведении ГДМ',
            'depth_manometr' => 'Глубина спуска манометра',
            'Pzatr_Ppl' => 'Рзатр при замере Рпл',
            'diameterHCH' => 'Диаметр НСН',
            'L_m' => 'L, м',
            'n_min' => 'n, мин',
            'd_shkiv' => 'Диаметр шкива привода',
            'd_dvig' => 'Диаметр шкива электродвигателя',
            'count_num' => 'Число оборотов',
            'well' => 'Скважина',
            'meas_date' => 'Дата исследования',
            'pint' => 'Давление на приеме насоса, атм',
            'pfll' => 'Давление на выкидной линии, атм',
        ],
        'well_treatment' => [
            'title' => 'Обработка',
            'treat' => 'Обработка',
        ...
        'production_wells_m_p' => [
            'title' => 'МЭР (Добывающие скважины)',
            'date_from' => 'Дата с',
            'date_to' => 'Дата по',
            'date' => 'Дата',
            ...
            'well_geo' => 'Горизонт',
            'well_block' => 'Блок',
            'well_expl' => 'Способ эксплуатации (последний)',
            'oil_vol' => 'Нефть (м3)',
            'oil_mass' => 'Нефть (т)',
            'water_vol' => 'Вода (м3)',
            'water_mass' => 'Вода (т)',
            ...
            'liq_mass' => 'Жидкость (т)',
            'liq_vol' => 'Жидкость (м3)',
            'oil_mass_rate' => 'Дебит нефти (т/сут)',
            'oil_vol_rate' => 'Дебит нефти (м3 /сут)',
            'water_mass_rate' => 'Дебит воды (т/сут)',
            'water_vol_rate' => 'Дебит воды (м3 /сут)',
            'gas_vol_rate' => 'Дебит газа (ксм3 /сут)',
            'liq_mass_rate' => 'Дебит жидкости (т/сут)',
            'liq_vol_rate' => 'Дебит жидкости (м3 /сут)',
            'wcut_mass' => 'Обводненность весовая (%)',
            'wcut_vol' => 'Обводненность объемная (%)',
            'gor_vol' => 'Газонефтяной фактор ГНФ (м3/м3)',
            'gor_mass' => 'Газонефтяной фактор ГНФ (м3/т)',
            'work_hours' => 'Отработанное время (часы)',
            'work_day' => 'Отработанное время (дни)',
            'downtime_day' => 'Простой (дни)',
            'work_cal_day' => 'Отработано Календарных дней'
        ],
        'injection_wells_m_p' => [
            'title' => 'МЭР (Нагнетательные скважины)',
            'date_from' => 'Дата с',
            'date_to' => 'Дата по',
            'date' => 'Дата',
            'source' => 'Источник данных',
            'well_geo' => 'Горизонт',
            'well_block' => 'Блок',
            'work_hours' => 'Количество отраб. часов в закачке воды',
            'work_hours_pol' => 'Количество отраб. часов в закачке полимера',
            'work_day' => 'Кол-во отработ. дней в закачке воды',
            'downtime_day' => 'Кол-во дней в простое закачки воды',
            'work_day_pol' => 'Количество отраб. дней в закачке полимера',
            'downtime_day_pol' => 'Кол-во дней в простое закачки полимера',
            'water_vol' => 'Факт. объем закачиваемой воды (м3)',
            'water_vol_rate' => 'Факт. дебит закачиваемой воды (м3/сут)',
            'pol_agent_rate' => 'Ср. расход маточного раствора (м3/ сут)',
            'pol_water_rate' => 'Ср. расход воды растворения (м3/ сут)',
            'pol_mix_rate' => 'Ср. приемистость полимерной смеси (м3/ сут)',
            'pol_agent_vol' => 'Объем закаченного маточного раствора м3',
            'pol_water_vol' => 'Объем закаченного воды растворения м3',
            'pol_total_vol' => 'Объем закаченной полимерной смеси м3',
            'pol_dry_mass' => 'Расход сухого полимера за месяц (кг)',
            'pol_inlet_pressure' => 'Среднее Входное давление пластовой воды Рвх (бар)',
            'pol_mix_viscosity' => 'Средняя Вязкость раствора на скв. (Сп)',
            'pol_outlet_pressure' => 'Среднее Давление насоса, Рвых (бар)',
            'pol_concentration' => 'Средняя Концентрация полимера на скв. на конец дня, ррm'
        ]
    ],
