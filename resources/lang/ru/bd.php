...
return [
    ...
    'forms' => [
        ...
        'gdis' => [
            ...
            'tag' => 'Наименование тэга',
            'uwi' => 'Период работы скважины до ГДИ (по ТБД), ч',
            'dbeg' => 'Давление насыщения, атм',
            'dend' => 'Модель пласта',
            'research_type' => 'Граница пласта',
            'depth' => 'Скин-фактор',
            'aim' => 'Проницаемость, мД',
            'conclusion' => 'Заключение',
            'tag' => 'Упругоемкость',
            'uwi' => 'Выводы',
            'dbeg' => 'Рекомендации',
            'dend' => 'Радиус скважины, м',
            'research_type' => 'Общая эфф. толщина, м',
            'depth' => 'Пористость, д.е',
            'aim' => 'Объемный коэффициент жид.',
            'conclusion' => 'Вязкость жид., сПз (мПа*с)',
            'tag' => 'Общая сжимаемость системы, см2/кг	',
            'uwi' => 'Модель ствола скважины',
            'dbeg' => 'Модель границы',
            'dend' => 'Пластовое давление в прискважинной зоне, кг/см2',
            'research_type' => 'Р буф. нач., кг/см2',
            'depth' => 'Р буф. кон., кг/см2',
            'aim' => 'Проводимость, мз',
            'conclusion' => 'Р пл на ВОП, атм',
            'tag' => 'Р пл на НОП, атм',
            'uwi' => 'Р пл на ВНК, атм',
            'dbeg' => 'Гидропроводность, м3/МПа*с',
            'dend' => 'Пьезопроводность, м2/с',
            'research_type' => 'Температура, С',
            'depth' => 'Радиус исслед., м',
            'aim' => 'Общая эфф. толщина, м',
            'conclusion' => 'Пористость, д.е.',
            'tag' => 'Объемный коэфф. жид.',
            'uwi' => 'Вязкость жид., сПз (мПа*с)',
            'dbeg' => 'Общая сжимаемость системы, см2/кг',
            'dend' => 'Модель ствола скважины',
            'research_type' => 'Модель границы',
            'depth' => 'Пластовое давление в прискважинной зоне, кг/см2',
            'aim' => 'Проницаемость, мД',
            'conclusion' => 'Заключение',
            'tag' => 'Упругоемкость',
            'uwi' => 'Выводы',
            ...
            'dbeg' => 'Модель границы',
            'dend' => 'Пластовое давление в прискважинной зоне, кг/см2',
            'research_type' => 'Коэффициент продуктивности, м3/сут*атм',
            'depth' => 'Полудлина трещины, м',
            'aim' => 'Глубина спуска манометра, м',
            'conclusion' => 'Модель скважины',
            'tag' => 'Расстояние до границы, м',
            'conclusion' => 'Забойное давление, кг/см2',
            'tag' => 'Пластовое давление, кг/см2',
            'tag' => 'Р прив, ат',
            'tag' => 'Пористость, д.е.',
            'tag' => 'Режим',
            'tag' => 'Штуцер',
            'tag' => 'Приемистость',
            'tag' => 'Затрубное давление',
            'tag' => 'Коэффициент приемистости, м3/сут/ат',
            'tag' => 'Темп качания/длина хода (диам.штуц.,шкиф мм), кач/мин/м',
            'tag' => 'Дебит жидкости, м3/сут',
            'tag' => 'Содержание воды, %',
            'tag' => 'Дебит нефти',
            'tag' => 'Н дин, м',
            'tag' => 'Прибор',
            'tag' => 'Искусственный забой',
            'tag' => 'Н ротора',
            'tag' => 'Интервалы перфорации',
            'tag' => 'Средний интервал перфорации',
            'tag' => 'Н забой',
            'tag' => 'Р буф',
            'tag' => 'Рпл',
            'tag' => 'Р приведенное',
            'tag' => 'Статический уровень',
            'tag' => 'Давление пластовое'         
        ],
        'well_treat' => [
            'uwi' => 'Номер скважины',
            'volume' => 'Объем, м3',
