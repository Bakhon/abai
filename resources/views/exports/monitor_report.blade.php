<table style="width: 100%;">
    ...
    <tr>
        ...
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center"></th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center"></th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="3">ОМГ ДДНГ</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="7">ОМГ УХЭ</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="9">База данных по скорости коррозии</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="9">ОМГ НГДУ</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="25">База данных по промысловой жидкости и газу</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="10">База данных по нефти и газу</th>
    </tr>
    <tr>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center"></th>
        ...
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="5">Содержание тяжелых металлов в воде</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="3">Растворенные в воде газы</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="3">Содержание бактерий</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="5">Свойства нефти</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold; text-align: center" colspan="5">Свойства газа</th>
    </tr>
    <tr>
        ...
        <th style="border: 1px solid black; height: 20px; font-weight: bold">Дата начало</th>
        ...
        <th style="border: 1px solid black; height: 20px; font-weight: bold">Скорость коррозии с реагентом, мм/г</th>
        ...
        <th style="border: 1px solid black; height: 20px; font-weight: bold">Содержание трехвалентного железа мг/дм3</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold">Содержание двухвалентного железа мг/дм3</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold">H2S (после буферной емкости), мг/дм3</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold">О2, мг/дм3</th>
        <th style="border: 1px solid black; height: 20px; font-weight: bold">CO2 (после буферной емкости), мг/дм3</th>
