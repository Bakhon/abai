        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ecorefsprocdob.update', $row->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                               ...
                               <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Процент от добычт на реализацию:</strong>
                                        <input type="float" name="proc_dob" value={{$row->proc_dob}} class="form-control" placeholder="Пример: 0.15">
                                    </div>
                                </div>
