        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ecorefsavgmarketprice.update',$row->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="float" name="exp_cust_duty_rate" class="form-control" placeholder="" value="{{$row->exp_cust_duty_rate}}">
                                    </div>
                                </div>
