...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <a href="{{ route('ecorefsempper.index')}}"
               class="btn btn-info">
    ...
    <div class="container bg-dark text-white my-3 py-3">
        ...
        <form method="post"
              ...
              action="{{ route('empper_data_import') }}">
            {{ csrf_field() }}
            <div class="form-group">
                ...
                <input type="file"
                       name="file"
                       accept="{{\App\Http\Requests\EcoRefs\EmpPer\ImportExcelEcoRefsEmpPerRequest::MIME_TYPES}}"
