        ...
        <div class="row digital_drilling">
            ...
            <div class="col-sm-2 rightBlock">
                <div class="analyticsBlock">
                    <div class="mspBlock">
                        <canvas id="msp1" height="140"></canvas>
                        <p><span>Общая средняя МСП</span><span>6054</span></p>
                    </div>
                </div>
                <div class="analyticsBlock">
                    <div class="mspBlock">
                        <canvas id="msp2" height="140"></canvas>
                        <p><span>Средняя коммерческая МСП</span><span>7011</span></p>
                    </div>
                </div>
                <div class="analyticsBlock">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        initGauge('msp1', 6054, options);
        initGauge('msp2', 7011, options);
    });
