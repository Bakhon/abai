            ...
            <div class="bodyContent">
                ...
                <div class="dropdown">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                        Геонавигация 3<i class="fas fa-chevron-down"></i>
                    </button>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <img src="/img/digital-drilling/geo3.png" alt="" style="max-width: 90%;width: 90%;display: table;margin: 20px auto;height: auto;">
                    </div>
                </div>
            </div>
        </div>
