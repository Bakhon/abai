            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-primary" href="{{ route('abd35.index') }}">{{__('app.back')}}</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('abd35.update', $row->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="float" name="aim_params" value="{{$row->aim_params}}" class="form-control" placeholder="Пример: 0.5">
                                    </div>
                                </div>
                                <!-- <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Факт:</strong>
                                        <input type="float" name="fact" value={{$row->fact}} class="form-control" placeholder="Пример: 0.5">
                                    </div>
                                </div> -->
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
