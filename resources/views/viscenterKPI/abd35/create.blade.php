        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('abd35.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="float" name="aim_params" class="form-control" placeholder="Пример: 0.5">
                                    </div>
                                </div>
                                <!-- <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Факт:</strong>
                                        <input type="float" name="fact" class="form-control" placeholder="Пример: 0.5">
                                    </div>
                                </div> -->
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
