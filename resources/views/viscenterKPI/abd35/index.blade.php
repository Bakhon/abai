            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-success" href="{{ route('abd35.create') }}">+</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($abd35 as $item)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('abd35.destroy',$item->id) }}" method="POST">
                                            <a class="btn btn-primary" href="{{ route('abd35.edit',$item->id) }}">{{__('app.edit')}}</a>
                                            @csrf
                                            @method('DELETE')
