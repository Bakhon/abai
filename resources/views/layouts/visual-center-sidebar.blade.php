...
<div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
    ...
    <ul class="list-group">
        ...
        <a href="#submenu1" data-toggle="collapse" aria-expanded="false">
            <div class="assets2" tabindex="-0">Операционные активы
            </div>
        </a>
        ...
        <div id='submenu2' class="collapse sidebar-submenu">
            ...
            <a href="{{url('/')}}/ru/visualcenter?company=КБМ" class="bg-dark list-group-item list-group-item-action circle-menu">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="{{url('/')}}/ru/visualcenter?company=КГМ" class="bg-dark list-group-item list-group-item-action circle-menu">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="{{url('/')}}/ru/visualcenter?company=ММГ" class="bg-dark list-group-item list-group-item-action circle-menu">
                <div class="d-flex w-100 justify-content-start align-items-center">
            ...
            <a href="{{url('/')}}/ru/visualcenter?company=КОА" class="bg-dark list-group-item list-group-item-action circle-menu">
                <div class="d-flex w-100 justify-content-start align-items-center">
    ...
    <a href="#submenu2" data-toggle="collapse" aria-expanded="false">
        <div class="assets" tabindex="-0">Неоперационные активы
        </div>
    </a>
    <div id='submenu2' class="collapse sidebar-submenu">
        <ul class="list-group">
    ...
    <div class="left-price-oil">
        <div class="left-price-oil2">
            Курс доллара <div class="price-border ">412.1 &#8376;</div>
        </div>
        <ul class="oil-string-all">
