    ...
    <div class="left-panel">
        <ul class="menu-collapsed padding" aria-expanded="false" data-toggle="collapse show">
            ...
            <div class="dropright">
                ...
                <div class="dropdown-menu">
                    <div class="move-menu">
                        <li class="left-menu-li"><a class=>Казгермунай</li>


                        <li class="left-menu-li">Мангистаумунайгаз</li>
                        <li class="left-menu-li">ЭмбаМунайГаз</li>
                        <li class="left-menu-li">Казахойл</li>
                        <li class="left-menu-li">КаражанбасМунай</li>
                    </div>
                </div>
            </div>
            ...
            <div class="dropright">
                ...
                <div class="dropdown-menu">
                    <div class="move-menu">
                        ...
                        <li class="left-menu-li"> <a href="{{url('/')}}/ru/monitor">Модуль "Мониторинг осложнений"</a></li>
                    </div>
                </div>
            </div>
