...
Vue.component('file-status-form', require('./components/bigdata/las/refs/fileStatus/form.vue').default);
Vue.component('recording-method-form', require('./components/bigdata/las/refs/recordingMethod/form.vue').default);
Vue.component('recording-state-form', require('./components/bigdata/las/refs/recordingState/form.vue').default);
Vue.component('stem-section-form', require('./components/bigdata/las/refs/stemSection/form.vue').default);
Vue.component('stem-type-form', require('./components/bigdata/las/refs/stemType/form.vue').default);
Vue.component('file-type-form', require('./components/bigdata/las/refs/fileType/form.vue').default);
