...
Vue.component('monitor-table', () => import(/* webpackChunkName : "monitor-table" */ './components/complicationMonitoring/monitor/MonitorTable.vue'));
Vue.component('monitor-chart', () => import(/* webpackChunkName : "monitor-chart" */ './components/complicationMonitoring/monitor/chart.vue'));
Vue.component('monitor-chart-radialbar', () => import(/* webpackChunkName : "monitor-chart-radialbar" */ './components/complicationMonitoring/monitor/MonitorChartRadialBar.vue'));
Vue.component('wm-form', () => import(/* webpackChunkName : "wm-form" */ './components/wm/form.vue'));
Vue.component('omgca-form', () => import(/* webpackChunkName : "omgca-form" */ './components/complicationMonitoring/omgca/form.vue'));
Vue.component('omguhe-form', () => import(/* webpackChunkName : "omguhe-form" */ './components/complicationMonitoring/omguhe/form.vue'));
Vue.component('omgngdu-form', () => import(/* webpackChunkName : "omgngdu-form" */ './components/complicationMonitoring/omgngdu/form.vue'));
Vue.component('omgngdu-well-form', () => import(/* webpackChunkName : "omgngdu-well-form" */ './components/complicationMonitoring/omgngdu_well/form.vue'));
Vue.component('gu-form', () => import(/* webpackChunkName : "gu-form" */ './components/complicationMonitoring/gu/form.vue'));
Vue.component('zu-form', () => import(/* webpackChunkName : "zu-form" */ './components/complicationMonitoring/zu/form.vue'));
...
Vue.component('view-table', () => import(/* webpackChunkName : "view-table" */ './components/complicationMonitoring/omgca/table.vue'));
Vue.component('oilgas-form', () => import(/* webpackChunkName : "oilgas-form" */ './components/complicationMonitoring/oilGas/form.vue'));
Vue.component('pipe-form', () => import(/* webpackChunkName : "pipe-form" */ './components/complicationMonitoring/pipes/form.vue'));
Vue.component('pipe-type-form', () => import(/* webpackChunkName : "pipe-type-form" */ './components/complicationMonitoring/pipeTypes/form.vue'));
Vue.component('las-dictionaries-form', () => import(/* webpackChunkName : "las-dictionaries-form" */ './components/bigdata/las/refs/lasDictionaries/form.vue'));
...
Vue.component('gu-map', () => import(/* webpackChunkName : "gu-map" */ './components/complicationMonitoring/map/map.vue'));
