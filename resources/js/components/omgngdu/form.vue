<template>
    <div class="col-xs-12 col-sm-12 col-md-12 row">
        <div class="col-xs-12 col-sm-4 col-md-4">
            ...
            <div class="form-label-group">
                <input v-model="formFields.pump_discharge_pressure" type="number" step="0.0001"
                       name="pump_discharge_pressure" class="form-control" placeholder="">
            </div>
            <label>Обводненность в ГУ, %</label>
            <div class="form-label-group">
                <input v-model="formFields.bsw" type="number" step="0.0001" name="bsw" class="form-control"
                       placeholder="">
            </div>
            <label>Суточная добыча воды, м3/сут</label>
            <div class="form-label-group">
                <input v-model="formFields.daily_water_production" type="number" step="0.0001"
                       name="daily_water_production" class="form-control" placeholder="">
            </div>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4">
            <label>НГДУ</label>
            ...
            <div class="form-label-group">
                <input v-model="formFields.daily_fluid_production" type="number" step="0.0001"
                       name="daily_fluid_production" class="form-control" placeholder="">
            </div>
            <label>Температура на входе в печь в ГУ, С</label>
            <div class="form-label-group">
                <input v-model="formFields.heater_inlet_pressure" type="number" step="0.0001"
                       name="heater_inlet_pressure" class="form-control" placeholder="">
            </div>
            <label>Суточная добыча нефти, т/сут</label>
            <div class="form-label-group">
                <input v-model="formFields.daily_oil_production" type="number" step="0.0001" name="daily_oil_production"
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            ...
            <div class="form-label-group">
                <input v-model="formFields.surge_tank_pressure" type="number" step="0.0001" name="surge_tank_pressure"
                       class="form-control" placeholder="">
            </div>
            <label>Количество газа в СИБ, ст.м3/сут</label>
            <div class="form-label-group">
                <input v-model="formFields.daily_gas_production_in_sib" type="number" step="0.0001"
                       name="daily_gas_production_in_sib" class="form-control"
                       placeholder="">
            </div>
            <label>Температура на выходе из печи в ГУ, С</label>
            <div class="form-label-group">
                <input v-model="formFields.heater_output_pressure" type="number" step="0.0001"
                       name="heater_output_pressure" class="form-control" placeholder="">
            </div>
        </div>
