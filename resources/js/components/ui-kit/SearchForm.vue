...
export default {
  ...
  watch: {
    searchStringModel: function (newVal, oldVal) {
      this.$emit('update:searchString', newVal);
    },
    searchString: function (newVal, oldVal) {
      this.searchStringModel = newVal;
    },
  },
  methods: {
    search() {
