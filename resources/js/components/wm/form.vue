<template>
    <div class="col-xs-12 col-sm-12 col-md-12 row">
        <div class="col-xs-12 col-sm-4 col-md-4">
            ...
            <label>SO42-</label>
            <div class="form-label-group">
                <input v-model="formFields.sulphate_ion" type="number" step="0.0001" name="sulphate_ion" class="form-control" placeholder="">
            </div>
            <label>Mg2+</label>
            <div class="form-label-group">
                <input v-model="formFields.magnesium_ion" type="number" step="0.0001" name="magnesium_ion" class="form-control" placeholder="">
            </div>
            <label>рН</label>
            <div class="form-label-group">
                <input v-model="formFields.ph" type="number" step="0.0001" name="ph" class="form-control" placeholder="">
            </div>
            ...
            <div class="form-label-group">
                <input v-model="formFields.strontium_content" type="number" step="0.0001" name="strontium_content" class="form-control" placeholder="">
            </div>
            <label>Содержание трехвалентного железа мг/дм3</label>
            <div class="form-label-group">
                <input v-model="formFields.ferric_iron_content" type="number" step="0.0001" name="ferric_iron_content" class="form-control" placeholder="">
            </div>
            <label>О2, мг/дм3</label>
            <div class="form-label-group">
                <input v-model="formFields.oxygen" type="number" step="0.0001" name="oxygen" class="form-control" placeholder="">
            </div>
            <label>УОБ, кл/см3</label>
            <div class="form-label-group">
                <select class="form-control" name="hydrocarbon_oxidizing_bacteria_id" v-model="formFields.hydrocarbon_oxidizing_bacteria_id">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            ...
            <label>НСО3</label>
            <div class="form-label-group">
                <input v-model="formFields.hydrocarbonate_ion" type="number" step="0.0001" name="hydrocarbonate_ion" class="form-control" placeholder="">
            </div>
            <label>Cl-</label>
            <div class="form-label-group">
                <input v-model="formFields.chlorum_ion" type="number" step="0.0001" name="chlorum_ion" class="form-control" placeholder="">
            </div>
            <label>Na+K+</label>
            <div class="form-label-group">
                <input v-model="formFields.potassium_ion_sodium_ion" type="number" step="0.0001" name="potassium_ion_sodium_ion" class="form-control" placeholder="">
            </div>
            <label>Общая минерализация, мг/дм3</label>
            <div class="form-label-group">
                <input v-model="formFields.mineralization" type="number" step="0.0001" name="mineralization" class="form-control" placeholder="">
            </div>
            <label>Содержание нефтепродуктов, мг/дм3</label>
            <div class="form-label-group">
                <input v-model="formFields.content_of_petrolium_products" type="number" step="0.0001" name="content_of_petrolium_products" class="form-control"
                       placeholder="">
            </div>
            <label>Содержание бария, мг/дм³</label>
            <div class="form-label-group">
                <input v-model="formFields.barium_content" type="number" step="0.0001" name="barium_content" class="form-control" placeholder="">
            </div>
            <label>Содержание двухвалентного железа мг/дм3</label>
            <div class="form-label-group">
                <input v-model="formFields.ferrous_iron_content" type="number" step="0.0001" name="ferrous_iron_content" class="form-control" placeholder="">
            </div>
            <label>CO2, мг/дм3 (после буферной емкости)</label>
            <div class="form-label-group">
                <input v-model="formFields.carbon_dioxide" type="number" step="0.0001" name="carbon_dioxide" class="form-control" placeholder="">
            </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            ...
            <label>СО32-</label>
            <div class="form-label-group">
                <input v-model="formFields.carbonate_ion" type="number" step="0.0001" name="carbonate_ion" class="form-control" placeholder="">
            </div>
            <label>Ca2+</label>
            <div class="form-label-group">
                <input v-model="formFields.calcium_ion" type="number" step="0.0001" name="calcium_ion" class="form-control" placeholder="">
            </div>
            <label>Плотность при 20°С, г/см3</label>
            <div class="form-label-group">
                <input v-model="formFields.density" type="number" step="0.0001" name="density" class="form-control" placeholder="">
            </div>
            <label>Общая жесткость, мг-экв/дм3</label>
            <div class="form-label-group">
                <input v-model="formFields.total_hardness" type="number" step="0.0001" name="total_hardness" class="form-control" placeholder="">
            </div>
            <label>Механические примеси, мг/дм3</label>
            <div class="form-label-group">
                <input v-model="formFields.mechanical_impurities" type="number" step="0.0001" name="mechanical_impurities" class="form-control" placeholder="">
            </div>
            <label>Содержание общего железа мг/дм3</label>
            <div class="form-label-group">
                <input v-model="formFields.total_iron_content" type="number" step="0.0001" name="total_iron_content" class="form-control" placeholder="">
            </div>
            <label>H2S, мг/дм3 (после буферной емкости)</label>
            <div class="form-label-group">
                <input v-model="formFields.hydrogen_sulfide" type="number" step="0.0001" name="hydrogen_sulfide" class="form-control" placeholder="">
            </div>
            <label>СВБ, кл/см3</label>
            <div class="form-label-group">
                <select class="form-control" name="sulphate_reducing_bacteria_id" v-model="formFields.sulphate_reducing_bacteria_id">
