<template>
	...
	<div class="flex-container">
		...
		<div class="flex__item__block__1">
			...
			<div class="title__block">{{trans('pgno.group_posadka')}}<svg style="padding-left: 4px;" @click="onClick()" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="flex__item__block__1">
					...
					<div class="title__block__pump">
						<div class="title__block__pump_list">
							...
							<div class="title__block__pump__1">
								<input value="1" @change="onChangeStupColumns" class="checkbox__block__1" v-model="stup" name="posad1" type="radio" />
								<label class="checkbox__block__label__1">1 {{trans('pgno.stup')}}</label>
							</div>

							<div class="title__block__pump__1">
								<input value="2" @change="onChangeStupColumns" class="checkbox__block__1" v-model="stup" name="posad1" type="radio" />
								<label class="checkbox__block__label__1">2 {{trans('pgno.stup')}}</label>
							</div>

							<div class="title__block__pump__1">
								<input value="3" @change="onChangeStupColumns" class="checkbox__block__1" v-model="stup" name="posad1" type="radio" />
						...
						<div class="title__block__pump_list__2">
							<div class="title__block__pump__1__heavy__down">
								<input class="checkbox__block__1" v-model="heavyDown" name="posad1" type="checkbox" />
			...
			<div class="flex__item__block__1">
				<div class="title__block">{{trans('pgno.marki_stali_shtang')}}
			...
			<div class="flex__item__block__1__koroz">
				<div class="title__block__koroz">
					{{trans('pgno.korozinost_dob_prod')}}
				</div>
				<div class="title__block__koroz__checkbox">
					<input class="checkbox__block__1" value="nekor" type="radio" name="korprod1" v-model="corrosion" @change="onChangeCorrosion"/>
					<label class="checkbox__block__label__1">{{trans('pgno.nekorozionnaya')}}</label>
				</div>

				<div class="title__block__koroz__checkbox__2">
					<input class="checkbox__block__1" value="srednekor"  type="radio" name="korprod1" checked v-model="corrosion" @change="onChangeCorrosion"/>
					<label for="" class="checkbox__block__label__1">{{trans('pgno.srenekorozionnaya')}}</label>
				</div>

				<div class="title__block__koroz__checkbox__3">
					<input class="checkbox__block__1" value="visokor"  type="radio" name="korprod1" v-model="corrosion" @change="onChangeCorrosion"/>
