<template>
  <div>
    ...
    <div class="params_block">
      ...
      <p>{{ trans('monitoring.gu.fields.daily_gas_production_in_sib')}}: {{guParams.daily_gas_production_in_sib}} {{trans('measurements.st.m3/day')}}</p>
      <p>{{ trans('monitoring.gu.fields.surge_tank_pressure')}}: {{guParams.surge_tank_pressure}} {{ trans('measurements.pressure_bar')}}</p>
    </div>
  </div>
</template>
