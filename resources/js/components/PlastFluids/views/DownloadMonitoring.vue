  ...
  <div class="wrapper">
    <div class="top_wrapper">
      <div class="select_wrapper_left">
        ...
        >
          <path
            d="M12.6099 2.85938V5.74349H15.494C15.494 4.15096 14.2024 2.85938 12.6099 2.85938Z"
            fill="white"
          />
          <path
            d="M12.1761 9.06145C13.7686 9.06145 15.0602 7.77043 15.0602 6.17733H12.1761V3.29321C10.5836 3.29321 9.29199 4.58423 9.29199 6.17733C9.        29199 7.77043 10.5836 9.06145 12.1761 9.06145Z"
            fill="white"
          />
          <path
            d="M3.63239 7.55103H2.50732V8.56528H3.63239V7.55103Z"
            fill="white"
          />
          <path
            d="M5.31257 5.19556H4.1875V8.56514H5.31257V5.19556Z"
            fill="white"
          />
          <path
            d="M6.99226 3.48315H5.86719V8.5651H6.99226V3.48315Z"
            fill="white"
          />
          <path
            d="M8.67243 6.72461H7.54736V8.56466H8.67243V6.72461Z"
            fill="white"
          />
          <path
            d="M5.9235 16.8749H4.92218V18H13.0789V16.8749H12.0776L11.6839 14.0966H17.0011C17.5534 14.0966 18.0011 13.6489 18.0011 13.0966V1C18.0011 0.447716 17.5534 0 17.0011 0H1C0.447717 0 0 0.447715 0 1V13.0971C0 13.6494 0.447715 14.0971 1 14.0971H6.31727L5.9235 16.8749ZM7.05982 16.8749L7.1442 16.2815L10.745 15.49L10.9413 16.8749H7.05982ZM10.5863 14.3728L7.31296 15.0928L7.45415 14.0966H10.5475L10.5863 14.3728ZM16.8761 1.12507V11.0459H1.12507V1.12507H16.8761ZM1.12507 12.171H16.8761V12.9715H1.12507V12.171Z"
            fill="white"
          />
        </svg>
...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {
          uploadDate: "27-04-1999",
          uploadAuthor: "Aset",
          subsoilUser: "ASet",
          fields: "AsetOil",
          selectionDateStart: "27-04",
          selectionDateEnd: "30-04",
          dataType: ".json",
        },
        {
          uploadDate: "27-04-1999",
...
<style lang="scss" scoped src="./DownloadMonitoringStyles.scss"></style>
