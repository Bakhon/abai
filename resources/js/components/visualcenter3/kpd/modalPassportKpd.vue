            ...
            <div class="modal-bign modal-bign-container">
                <div class="modal-bign-header">
                    ...
                    <div class="btn-toolbar">
                        <button type="button" class="modal-bign-button" @click="[isOperationFinished = true,$modal.hide('modalPassportKpd')]">
                            {{trans('pgno.zakrit')}}
                        </button>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async store() {
            ...
            this.$modal.hide('modalPassportKpd');
        },
        async deleteKpd() {
