<template>
    <div class="row main-layout">
        ...
        <div class="col-2 row mt-3 ml-1">
            ...
            <div
                    id="chemistryButton"
                    :class="[!isChemistryButtonVisible ? '' : 'chemistry-button_animation','col-12 status-block status-block_little menu__button ml-1']"
            ...
            <div
                    :class="[!isWellsWorkoverNeeded ? '' : 'chemistry-button_animation','col-12 status-block status-block_little menu__button ml-1 mt-3']"
