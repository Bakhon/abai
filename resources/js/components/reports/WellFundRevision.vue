  ...
  <div class="filter-container">
    ...
    <div class="form-group1 filter-group select">
      ...
      >
        ...
        <option value="1">Добывающий фонд</option>
        <option value="2">Нагнетательный фонд</option>
        <option value="3">Б/Д добывающий фонд</option>
    ...
    <div class="form-group4">
      <button :disabled="!org || !fondType || !end_date || $store.state.globalloading.loading"
              @click="updateData()"
...
export default {
  ...
  data() {
    ...
    updateData() {
      let fondTypeByFundId = {
        1: "добывающий фонд",
        2: "нагнетательный фонд",
        3: "Б/Д добывающий фонд",
