<template>
  <div class="row align-items-stretch">
    <div class="col-xl-9 col-sm-12">
      <div class="row">
        <div :class="{'expand': formsListExpanded}" class="forms-list col-12 blueblock one">
          ...
          <div class="blueblock__buttons d-flex flex-wrap scrollable">
            <div v-for="button in filteredFormButtons" class="blueblock__buttons-button">
