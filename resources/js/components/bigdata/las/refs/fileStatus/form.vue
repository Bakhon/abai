...
export default {
      ...
      this.axios
          ...
          .then((response) => {
            if (response.data.status == 'success') {
              window.location.replace(this.localeUrl("bigdata/file_status"));
            }
          });
    }
  },
  computed: {
    ...
    requestUrl () {
      return this.isEditing ? this.localeUrl("bigdata/file_status/" + this.fileStatus.id) : this.localeUrl("bigdata/file_status");
    },
    requestMethod () {
