    ...
    <div class="digitalDrillingTablesPage">
        <div class="digitalDrillingTables-head">
            <div class="digitalDrillingTables-head-title">
                {{ trans('digital_drilling.borehole_deepening')}}
            </div>
        ...
        <report-download v-if="download" @close="download = !download">
            <template #tableBody>
                <div class="name">Углубление скважины</div>
                <div class="black">Табл. 1.8.1. Способы, режимы бурения, расширки (проработки) ствола скважины и применяемые КНБК</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th colspan="2">
                ...
                <div class="black">Табл. 1.8.2. Компоновка низа бурильных колонн (КНБК)</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th rowspan="3">
                ...
                <div class="black">Табл. 1.8.3. Потребное количество элементов КНБК</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th rowspan="2">
                ...
                <div class="black">Табл. 1.8.4. Суммарное количество и масса КНБК</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th rowspan="3">
                ...
                <div class="black">Табл. 1.8.5. Рекомендуемые бурильные трубы</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th>Обозначение бурильной колонны</th>
                ...
                <div class="black">Табл. 1.8.6. Конструкция бурильных колонн</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th rowspan="2">Вид технологической операции</th>
                ...
                <div class="black">Табл. 1.8.7. Характеристика и масса бурильных труб, УБТ по интервалам бурения с учетом дефицита длины труб</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th rowspan="2">Название обсадной колонны</th>
                ...
                <div class="black">Табл. 1.8.8. Оснастка талевой системы</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th colspan="2">Интервал по стволу, м</th>
                ...
                <div class="black">Табл. 1.8.9. Режим работы буровых насосов</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th colspan="2">Интервал по стволу, м</th>
                ...
                <div class="black">Табл. 1.8.10. Распределение потерь давлений в циркуляционной системе буровой</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th colspan="2">Интервал (по столу), м</th>
                ...
                <div class="black">Табл. 1.8.11. Гидравлические показатели промывки</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th colspan="2">Интервал (по столу), м</th>
