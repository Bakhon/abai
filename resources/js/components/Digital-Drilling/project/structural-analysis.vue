    ...
    <div class="digitalDrillingTablesPage">
        ...
        <report-download v-if="download" @close="download = !download">
            <template #tableBody>
                ...
                <div class="black">Табл. 1.5.1 Характеристика и устройство шахтового направления</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th colspan="6">Хapaктepиcтикa тpубы</th>
                ...
                <div class="black">Табл. 1.5.2 Глубина спуска и характеристика обсадных колонн</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th rowspan="2">Номер колонны в порядке спуска</th>
                ...
                <div class="black">Табл. 1.5.3 Характеристика раздельно спускаемых частей обсадных колонн</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th rowspan="4">Номер колонны в порядке спуска (см. табл. 5.2, гр.1)</th>
                ...
                <div class="black">Табл. 1.5.4 Tехнико-технологические мероприятия, предусмотренные при строительстве скважины по проектной конструкции</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th>П/П</th>
