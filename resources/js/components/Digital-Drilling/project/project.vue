    ...
    <div class="digitalDrillingTablesPage">
        ...
        <report-download v-if="download" @close="download = !download">
            <template #tableBody>
                ...
                <div class="black">Табл. 1.6.1 Входные данные по профилю скважины</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th rowspan="2" colspan="2">
                ...
                <div class="black">Табл. 1.6.2 Профиль ствола скважины</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th>Глубина по стволу [m]</th>
                ...
                <div class="black">Координаты точек</div>
                <table class="table defaultTable">
                    <tbody>
                    <tr>
                        <th>Название</th>
