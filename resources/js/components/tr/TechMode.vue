...
export default {
  ...
  methods: {
    getHeaderCellClassName({row, column, rowIndex, columnIndex}) {
      ...
      if(column.id === "el-table_1_column_13") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_17") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_21") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_25") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_29") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_31") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_33") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_37") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_41") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_45") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_49") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_51") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_53") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_57") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_61") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_65") {
        return 'no_border';
      }



      if(column.id === "el-table_1_column_69") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_73") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_77") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_81") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_85") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_89") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_93") {
        return 'no_border';
      }
      if(column.id === "el-table_1_column_97") {
        return 'no_border';
      }
      return 'have_border';
    },
