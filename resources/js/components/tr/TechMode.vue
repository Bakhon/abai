...
export default {
  ...
  data: function () {
    return {
      ...
      checkers: false,
      checkersec: false,
      is_border_column_id: ["el-table_1_column_1", "el-table_1_column_5", "el-table_1_column_9", "el-table_1_column_13", "el-table_1_column_17", 
      ...
      "el-table_1_column_61", "el-table_1_column_65", "el-table_1_column_69",  "el-table_1_column_73", "el-table_1_column_77", "el-table_1_column_81", "el-table_1_column_85",
       "el-table_1_column_89", "el-table_1_column_93", "el-table_1_column_97"],
  ...
  methods: {
    getHeaderCellClassName({column}) {
      ...
      if(this.is_border_column_id.includes(column.id)) {
        return 'no_border';
      }
      return 'have_border';
    },
