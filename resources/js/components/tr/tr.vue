    ...
    <div class="col-md-12 row">
      <div class="col-md-12 row justify-content-between">
        ...
        <div class="col dropdown">
          ...
          >
            <div>
              <!-- <label class="text-wrap" style="color: white" for="companySelect"
                >Выберите месяц</label
              > -->
              <select
                style="
            ...
            <a href="#" @click.prevent="chooseDt" class="but-nav__link but"
              style="background: #333975">Сформировать</a
            >
          </div>
        </div>
        <!-- <div>
    ...
    <div class="col-md-12 maintable">
      <div class="maintable-level2">
        <div class="techvers" style="display: flex">
          <div class="tech">
            <h3 style="color: white; margin-left: 7px">
          ...
          >
            ...
            <tr v-for="(row, row_index) in wells" :key="row_index">
              ...
              >
                ...
                <input
                  @change="editrow(row, row_index)"
                  v-model="row.well_status_last_day[0]"
                  :disabled="!edit"
                />
                <!-- <span>{{row.well_status_last_day[0]}}</span> -->
                <span v-if="wells && wells[row_index]" class="cell-comment">
              ...
              >
                ...
                <input
                  @change="editrow(row, row_index)"
                  v-model="row.well_project_purpose[0]"
                  :disabled="!edit"
                />
                <!-- <span>{{row.well_project_purpose[0]}}</span> -->
                <span v-if="wells && wells[row_index]" class="cell-comment">
...
export default {
  ...
  beforeCreate: function () {
    ...
    this.axios
      .get("http://172.20.103.51:7576/api/techregime/" + yyyy + "/" + 10 + "/")
      .then((response) => {
