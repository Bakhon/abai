        ...
        >
          <thead>
            <tr class="headerColumn sticky" style="background: #333975">
              ...
              <td class="colspan th" colspan="5">Данные за предыдущий месяц</td>
              <td class="colspan th" colspan="4">Фактический режим</td>
              <td rowspan="4"  class="th"><span>Состояние на конец месяца</span></td>
              ...
              <td rowspan="4" class="th"><span>Фонтан через насос</span></td>
              ...
              <td class="colspan th" colspan="3">Планируемые мероприятия</td>
              ...
              <td rowspan="4" class="th"><span>Дата последнего ГТМ</span></td>
              <td rowspan="4" class="th"><span>Вид последнего ГТМ</span></td>
            ...
            <tr class="headerColumn" style="background: #333975">
              ...
              <td rowspan="3" class="th"><span>К пр от стимуляции</span></td>
              <td class="colspan th" colspan="4">ГРП</td>
              ...
              <td rowspan="3" class="th"><span>Добыча нефти за месяц</span></td>
              <td rowspan="3" class="th"><span>Добыча газа за месяц</span></td>
              <td rowspan="3" class="th"><span>Добыча жидкость за месяц</span></td>
              <td rowspan="3" class="th"><span>Добыча воды за месяц</span></td>
              <td class="colspan th" colspan="2"><span>Изменения к режиму</span></td>
              <td rowspan="3">
            ...
            <tr class="headerColumn" style="background: #333975">
              ...
              <td rowspan="2" class="th"><span>Q ж с поправкой на D э/к</span></td>
              ...
              <td rowspan="2" class="th"><span>Число предупреждений</span></td>
              <td rowspan="2" class="th"><span>Первое предупреждение</span></td>
            ...
            <tr class="subHeaderColumn" style="background: #333975">
              <td @click="sortBy('gu')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              <td @click="sortBy('field')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              ...
              <td @click="sortBy('r_con')" class="th"><i class="fa fa-fw fa-sort"></i>м</td>
              ...
              <td @click="sortBy('type_sr')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              <td @click="sortBy('spm')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              ...
              <td @click="sortBy('whp')" class="th"><i class="fa fa-fw fa-sort"></i>атм</td>
              ...
              <td @click="sortBy('t_res')" class="th"><i class="fa fa-fw fa-sort"></i>ºC</td>
              <td @click="sortBy('wht')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              <td @click="sortBy('grp_skin')" class="th">
                <i class="fa fa-fw fa-sort"></i>
              </td>
              <td @click="sortBy('grp_jd')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              ...
              <td @click="sortBy('bo')" class="th"><i class="fa fa-fw fa-sort"></i>м3/м3</td>
              ...
              <td @click="sortBy('h_perf')" class="th"><i class="fa fa-fw fa-sort"></i>м</td>
              <td @click="sortBy('k')" class="th"><i class="fa fa-fw fa-sort"></i>мД</td>
              <td @click="sortBy('kh')" class="th"><i class="fa fa-fw fa-sort"></i>мДм</td>
              ...
              <td @click="sortBy('gp_total_inc')" class="th"><i class="fa fa-fw fa-sort"></i>т/сут</td>
              ...
              <td @click="sortBy('zone')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              <td @click="sortBy('tseh')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              ...
              <td @click="sortBy('curr_bh')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              ...
              <td @click="sortBy('EMPTY')" class="th"><i class="fa fa-fw fa-sort"></i></td>
              <td @click="sortBy('EMPTY')" class="th"><i class="fa fa-fw fa-sort"></i></td>
