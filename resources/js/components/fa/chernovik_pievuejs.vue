        ...
        <modal name="chart" :width="2000" :height="1000" :adaptive="true">
            <div class="main_modals">
                <div class="row">
                    ...
                    <div class="col-sm">
                        <div class="first_block">
                                <!-- v-if="pieChartData[tabPiesSelectedId].counts.labels.length > 0" -->
                            <pie-chart
...
export default {
        ...
        pieChartData(){
            if (this.chartWells && this.chartWells.length > 0){
                ...
                try {
                    ...
                    return {
                        labels: ['Pbh', 'wct', 'p_res', 'PI'],
                        datasets: [{
                            backgroundColor: ['#0070ff','#ff0000','#ff00ff','#00ff80'],
                            data: [
                                filteredData['Pbh'],
                                filteredData['wct'],
                                filteredData['p_res'],
  ...
  methods: {
      ...
      chooseSe() {
          ...
          this.wells = fullWells.filter(e => e.exp_meth === filter);
      },
      chooseField() {
          const { filter, fullWells } = this;
          console.log(filter, fullWells);
