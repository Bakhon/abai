                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="first_block">
                            <bar-chart class='bar_chart'></bar-chart>
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="first_block">
                            <pie-chart class='pie_chart'></pie-chart>
                        </div>
                    </div>
                    <div class="filter_chart">
                        ...
                        <div>
                            <select name="Company" class="form-control" id="companySelect"
                                v-model="filter" @change="chooseField" value="Месторождение">
                        ...
                        <div>
                            <select name="Company" class="form-control" id="companySelect"
                                v-model="filter" @change="choosePlast">
                                <option value="Акшабулак Центральный">Акшабулак Центральный</option>
                                <option value="Акшабулак Южный">Акшабулак Южный</option>
                                <option value="Акшабулак Восточный">Акшабулак Восточный</option>
                                <option value="Нуралы">Нуралы</option>
                        ...
                        <div>
                            <select name="Company" class="form-control" id="companySelect"
                                v-model="filter" @change="chooseSe">
                                <option value="Акшабулак Центральный">Акшабулак Центральный</option>
                                <option value="Акшабулак Южный">Акшабулак Южный</option>
                                <option value="Акшабулак Восточный">Акшабулак Восточный</option>
                                <option value="Нуралы">Нуралы</option>
