...
<!--            color="blue">-->
<!--          <div slot="marker"-->
<!--               style="width: 20px; height: 20px; background: url(/img/icons/zu.svg) no-repeat; background-size: contain"></div>-->
...
<!--            color="green">-->
<!--          <div slot="marker"-->
<!--               style="width: 25px; height: 25px; background: url(/img/icons/well.svg) no-repeat; background-size: contain"></div>-->
<!--          <template v-slot:default>-->
...
<!--            color="green">-->
<!--          <div slot="marker"-->
<!--               style="width: 30px; height: 30px; background: url(/img/icons/zu.svg) no-repeat; background-size: contain"></div>-->
<!--          <template v-slot:default>-->
...
export default {
  ...
  methods: {
    centerToGu() {
      this.center = this.guPoints.find((point) => {
      ...
      return {
        ...
        'paint': {
          ...
          'line-width': [
            ...
            ['linear'],
            ['zoom'],
            10, ["*", ["get", "line_width"], ["^", 2, 12]],
            24, ["*", ["get", "line_width"], ["^", 2, 819]]
          ],
        }
      }
    },
