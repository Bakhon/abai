...
export default {
  name: "economic-data-discontcoefbar-component",
  components: {
    VueTableDynamic,
    CatLoader,
    SelectScFa
  ...
  methods: {
    async getData() {
      ...
      const {data} = await this.axios.get(this.localeUrl('/eco_refs_discont_coef_bars'), {params: this.form})
  ...
  computed: {
    ...
    columns() {
      ...
      return [
        ...
        {value: 'month-year'},
        {value: 'barr_coef'},
        {value: 'discont', dimention: 'doll_to_barr'},
        {value: 'macro', dimention: 'export_course'}
      ]
    },
  }
};
