<template>
    <div class="table-page">
        <div class="float-right table-page__links">
            ...
            <a class="table-page__links-item table-page__links-item_excel" @click.prevent="exportExcel" href="#">
                <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.7071 5.70711L10.293 1.2929C10.1055 1.10536 9.8511 1 9.58588 1L2.00028 1.00002C1.448 1.00002 1.00029 1.44774 1.00029 2.00002L1.00029 18C1.00029 18.5523 1.448 19 2.00029 19L14 19C14.5523 19 15 18.5523 15 18L15 6.41421C15 6.14899 14.8946 5.89464 14.7071 5.70711Z" stroke="white" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M9.11719 1V6.02353C9.11719 6.57581 9.5649 7.02353 10.1172 7.02353H14.9994" stroke="white" stroke-width="1.4" stroke-linejoin="round"/>
        ...
        <div class="alert alert-success" v-if="params.message">
