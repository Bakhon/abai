        ...
        <div class="row m-0 pl-1 pt-1">
            <div class="gtm-dark col-lg-10 p-2 mb-2">
                ...
                <div class="block-header block-header pt-1 pb-3">
                    {{ trans('paegtm.gtm_starting_parameters_analysis_title') }}
                </div>

                <table class="table table-striped text-center text-white distribution-table startting-params-table mb-2">
                    <thead>
                    <tr>
...
<script src="./js/AegtmStartingParameters.js"></script>