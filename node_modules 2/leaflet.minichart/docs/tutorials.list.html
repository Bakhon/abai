...
<head>
	...
	<title>leaflet.minichart Exemples</title>
...
<div class="row">
	...
	<h1 class="page-title">Exemples</h1>
<section>
...
<dl class="details">
        ...
        <dl>
            <dt><a href="-_L.Minichart_.html">'L.Minichart'</a></dt>
            <dd>add add bar, pie and polar charts to a leaflet map</dd>
        </dl>
