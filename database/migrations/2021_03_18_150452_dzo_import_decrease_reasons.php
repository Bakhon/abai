...
class DzoImportDecreaseReasons extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('dzo_import_decrease_reasons', function (Blueprint $table) {
            ...
            $table->text("opec_explanation_reasons")->nullable();
            $table->text("opec_measures_taken")->nullable();
            ...
            $table->text("impulse_explanation_reasons")->nullable();
            $table->text("impulse_measures_taken")->nullable();
            ...
            $table->text("shutdown_explanation_reasons")->nullable();
            $table->text("shutdown_measures_taken")->nullable();
            ...
            $table->text("accident_explanation_reasons")->nullable();
            $table->text("accident_measures_taken")->nullable();
            ...
            $table->text("restriction_kto_explanation_reasons")->nullable();
            $table->text("restriction_kto_measures_taken")->nullable();
            ...
            $table->text("gas_restriction_explanation_reasons")->nullable();
            $table->text("gas_restriction_measures_taken")->nullable();
            ...
            $table->text("other_explanation_reasons")->nullable();
            $table->text("other_measures_taken")->nullable();
