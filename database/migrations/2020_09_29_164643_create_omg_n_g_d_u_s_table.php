...
class CreateOmgNGDUSTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('omg_n_g_d_u_s', function (Blueprint $table) {
            ...
            $table->float('heater_inlet_pressure', 8, 4)->nullable();
            $table->float('heater_output_pressure', 8, 4)->nullable();
            $table->float('kormass_number', 8, 4)->nullable();
            $table->float('pressure', 8, 4)->nullable();
            $table->float('temperature', 8, 4)->nullable();
            $table->float('daily_fluid_production_kormass', 8, 4)->nullable();
